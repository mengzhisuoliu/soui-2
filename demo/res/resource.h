...
struct _UIRES UIRES={
		...
		},
		{
			_T("ICON:ICON_0"),
			_T("ICON:ICON_LOGO"),
			_T("ICON:ICON_MM_ONLINE"),
			_T("ICON:ICON_MM_OFFLINE"),
			_T("ICON:ICON_Loading1"),
			_T("ICON:ICON_Loading2"),
			_T("ICON:ICON_Loading3"),
			_T("ICON:ICON_Loading4"),
			_T("ICON:ICON_Loading5"),
		...
		},
		{
			...
			_T("IMGX:btn_expand"),
			_T("IMGX:jpg_bkgnd"),
			_T("IMGX:png_page_icons"),
			_T("IMGX:png_small_icons"),
			_T("IMGX:webbtn_back"),
			_T("IMGX:webbtn_forward"),
			_T("IMGX:webbtn_refresh"),
			_T("IMGX:png_treeicon"),
		...
		},
		{
			...
			_T("img_calendar2:png_skin_btn_curve"),
			_T("img_calendar2:png_line_1px"),
			_T("img_calendar2:png_radio_button"),
			_T("img_calendar2:cal_arrow_left"),
			_T("img_calendar2:cal_arrow_right"),
			_T("img_calendar2:cal_btn_day"),
		},
		{
			_T("img_dock:PNG_MAINBK"),
			_T("img_dock:PNG_ICON_1"),
			_T("img_dock:PNG_ICON_2"),
			_T("img_dock:PNG_ICON_3"),
			_T("img_dock:PNG_ICON_4"),
			_T("img_dock:PNG_ICON_5"),
			_T("img_dock:PNG_ICON_6"),
			_T("img_dock:PNG_ICON_7"),
			_T("img_dock:PNG_ICON_8"),
			_T("img_dock:PNG_ICON_9"),
			_T("img_dock:PNG_ICON_10"),
		},
		{
			_T("img_game:img_coin"),
			_T("img_game:gif_win"),
			_T("img_game:gif_horse"),
		},
		{
			_T("img_clock:background"),
			_T("img_clock:pointer_hour"),
			_T("img_clock:pointer_minute"),
			_T("img_clock:pointer_second"),
		},
		{
			_T("bkimg:skin_pic_0"),
			_T("bkimg:skin_pic_1"),
			...
			_T("bkimg:skin_pic_8"),
			_T("bkimg:skin_pic_9"),
			_T("bkimg:skin_pic_10"),
			_T("bkimg:skin_pic_11"),
			_T("bkimg:skin_pic_12"),
			_T("bkimg:skin_pic_13"),
			_T("bkimg:skin_pic_14"),
			_T("bkimg:skin_pic_15"),
			_T("bkimg:skin_pic_16"),
			_T("bkimg:skin_pic_17"),
		},
		{
			_T("GIF:gif_penguin"),
		},
...
struct _R{
	struct _name{
		 ...
		 const wchar_t * img_round2;
		 const wchar_t * img_round3;
